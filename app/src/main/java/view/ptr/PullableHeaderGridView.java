...
public class PullableHeaderGridView extends GridView implements Pullable {
	...
	public PullableHeaderGridView(Context context) {
		super(context);
		initHeaderGridView();
	}

	public PullableHeaderGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initHeaderGridView();
	}
	...
	private class FullWidthFixedViewLayout extends FrameLayout {
		...
		@Override
		protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
			int targetWidth = PullableHeaderGridView.this.getMeasuredWidth()
					- PullableHeaderGridView.this.getPaddingLeft()
					- PullableHeaderGridView.this.getPaddingRight();
