...
public class PullToRefreshLayout extends RelativeLayout {
	...
	// 小兔子
	private ImageView pull_icon_one;
	private AnimationDrawable animationDrawable;
	private ImageView pull_icon_two;
	...
	Handler updateHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (pullDownY < 0) {
				...
				if (pull_icon_one.getDrawable() instanceof AnimationDrawable){
					animationDrawable = (AnimationDrawable) pull_icon_one
							.getDrawable();
			...
			if (pullUpY > 0) {
				...
				animationDrawable = (AnimationDrawable) pull_icon_two
						.getDrawable();
				animationDrawable.stop();
	...
	private void changeState(int to) {
		...
		case INIT:
			...
			pull_icon_one.setImageResource(R.drawable.refresh_animation);
			animationDrawable = (AnimationDrawable) pull_icon_one.getDrawable();
			...
			pull_icon_two.setImageResource(R.drawable.refresh_animation);
			animationDrawable = (AnimationDrawable) pull_icon_two.getDrawable();
			animationDrawable.start();
			break;
	...
	private void initView() {
		...
		pull_icon_one = (ImageView) refreshView
				.findViewById(R.id.pull_icon_one);
		...
		pull_icon_two = (ImageView) loadmoreView
				.findViewById(R.id.pull_icon_two);
